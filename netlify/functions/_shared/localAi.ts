...
export function fallbackSteps(kc: KnowledgeComponent, miniIndex: number): MiniStep[] {
  const steps = [
    ...
    ["Substitute 5 for `n`. Is `3n = 15` true?", "Choice after multiplication preview.", "True", "`3 \\times 5 = 15`."],
    ["Substitute 4 for `x`. Is `3x = 10` true?", "User enters `3x`, then chooses true/false.", "12; False", "`3 \\times 4 = 12`."],
    ["Which value makes `a + 6 = 14` true: 7 or 8?", "Two choice buttons with substitution preview.", "8", "The left side must equal 14."],
    ["Which value makes `0.4x = 20` true: 15 or 50?", "Two choice buttons with substitution preview.", "50", "`0.4 \\times 50 = 20`."],
    ["Explain why `0.4 \\times 15 = 20` is false.", "Short response.", "The left side is 6, not 20.", "Evaluate the left side first."],
